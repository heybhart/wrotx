...
const PRODUCT_DATA: Record<ProductId, ProductData> = {
  left: {
    ...
    image: 'https://images.unsplash.com/photo-1590658268037-6bf12165a8df?q=80&w=800', // Unsplash alternate for earbud left
    colors: {
  ...
  right: {
    ...
    image: 'https://images.unsplash.com/photo-1608156639585-b3a032ef9689?q=80&w=800', // Unsplash alternate for earbud right
    colors: {
...
export function EarbudShowcase() {
